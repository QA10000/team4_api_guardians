...
public class UserService {
    ...
    public void postUserRequest() {
    	...
    	UserRequest objUserReq = new UserRequest(	
				context.getuserComments(),
				context.getuserEduPg(),
				context.getuserEduUg(),
				context.getuserLinkedinUrl(),
				context.getuserMiddleName(),	
				context.getuserFirstName(),
				context.getuserLastName(),
				context.getuserLocation(),
				context.getuserTimeZone(),
				context.getuserVisaStatus(),
				context.getroleID(),
				context.getuserRoleStatus(),
				context.getuserLoginEmail(),
				context.getloginStatus(),
				context.getstatus(),
				context.getPhoneNumber()
			);
    	
    	 Response response = RestAssuredUtil.makeRequest("POST", context.getContentType(), objUserReq,context.getEndPoint());
    ...
    public void getUser_ByUserId() {
		...
		Response response = RestAssuredUtil.makeRequest("GET", context.getContentType(), objUserReq,context.getEndPoint());
		context.setLastResponse(response);
    ...
    public void putUser_ByInvalidUserId() {
		...
		Response response = RestAssuredUtil.makeRequest("put", context.getContentType(), objUserReq,context.getEndPoint());
		context.setLastResponse(response);
